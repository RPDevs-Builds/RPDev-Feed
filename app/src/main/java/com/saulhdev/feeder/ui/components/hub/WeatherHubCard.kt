...
fun WeatherHubCard(
    ...
    locationName: String = "Local Weather",
        ...
        Column(
            ...
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(
                        text = "${weather.temperature.toInt()}$tempUnit",
            ...
            Row(
                ...
                Text(
                    text = "Feels like ${weather.apparentTemperature.toInt()}$tempUnit",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.7f)
                )
                Text(
                    text = "💧 ${weather.relativeHumidity}% Humidity",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.7f)
                )
                Text(
                    text = "💨 ${weather.windSpeed.toInt()} $windUnit",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.7f)
                )
            }
